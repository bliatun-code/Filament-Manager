...
PR #116 er merget som `ad3aac5c`. Alle åtte kontroller bestod på `3fd2a994` etter én push: [CI](https://github.com/bliatun-code/Filament-Manager/actions/runs/34729101673) og [CodeQL](https://github.com/bliatun-code/Filament-Manager/actions/runs/34729101674). Loggene bekrefter de nye browser-, kjerne- og Host/Client-testene, macOS-DMG samt Windows MSI, backup og Host/Client. De pakkede flytene er bred regresjonsevidens; den nye lastingen uten veiing er direkte dekket i browser-, SQLite- og TCP-testene. Ingen release ble opprettet.
