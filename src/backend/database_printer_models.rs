...
pub struct PrinterAmsSlotRow {
    ...
    pub live_progress_percent: Option<i64>,
    pub live_remaining_minutes: Option<i64>,
    pub live_nozzle_temp_c: Option<f64>,
    pub live_bed_temp_c: Option<f64>,
    pub live_ams_humidity_index: Option<i64>,
    pub live_ams_temperature_c: Option<f64>,
