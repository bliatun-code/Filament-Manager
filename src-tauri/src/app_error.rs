...
pub(crate) fn internal_command_error(context: &str, diagnostic: impl std::fmt::Display) -> String {
    diagnostic_command_error("common.internal", context, diagnostic)
}

pub(crate) fn diagnostic_command_error(
    code: &'static str,
    context: &str,
...
#[cfg(test)]
mod tests {
    use super::{inventory_error_to_command_string, CommandErrorEnvelope};
    use crate::backend::database_result::InventoryError;
