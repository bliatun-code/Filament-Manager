...
use crate::companion_models::{
    ...
    CATALOG_REFRESH_JOBS_CAPABILITY, CATALOG_SPOOL_BATCH_CAPABILITY,
    FILAMENT_PRICE_STANDARDS_CAPABILITY, INVENTORY_BULK_MUTATION_CAPABILITY,
    INVENTORY_LOCATIONS_CAPABILITY, INVENTORY_MARK_EMPTY_CAPABILITY,
    INVENTORY_ROLL_STATUS_CAPABILITY, INVENTORY_ROLL_WEIGHT_CAPABILITY, LOAN_METADATA_CAPABILITY,
    PRINTER_SLOT_OPERATIONS_CAPABILITY, PURCHASE_RECEIPT_METADATA_CAPABILITY,
    SPOOL_COMMON_DETAILS_V2_CAPABILITY, STATISTICS_VALUE_COST_REPORT_CAPABILITY,
    VENDOR_CATALOG_DISCOVERY_CAPABILITY, WISHLIST_RECEIPT_LOCATION_CAPABILITY,
};
        ...
        .run_blocking("health check", move |state| {
            ...
            Ok(Json(CompanionHealthResponse {
                ...
                capabilities: &[
                    ...
                    CATALOG_SPOOL_BATCH_CAPABILITY,
                    PRINTER_SLOT_OPERATIONS_CAPABILITY,
                ],
