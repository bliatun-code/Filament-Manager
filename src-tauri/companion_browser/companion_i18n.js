...
const dictionaries = {
  en: {
    ...
    storage: {
      ...
      openSpoolByQr: "Open spool",
      qrScanner: "Scan QR",
      qrScannerHelp:
        "Use the device camera when the browser allows it, or pick a photo from the device to scan a QR code.",
      qrScannerStart: "Start camera",
      qrScannerStop: "Stop camera",
      qrScannerPhoto: "Scan from photo",
      qrScannerLiveUnavailable: "Live camera scanning is unavailable in this browser/session.",
    ...
    status: {
      ...
      qrScannerStarting: "Starting camera...",
      qrScannerLiveReady: "Camera is running. Point it at a QR code.",
      qrScannerLiveFailed: "Live QR scanning failed.",
      qrScannerLiveUnavailable: "Live camera scanning is not available in this browser session.",
      qrScannerVideoUnavailable: "QR scanner preview is unavailable.",
      qrScannerFound: "QR found. Opening spool...",
      qrScannerImageReading: "Scanning selected image...",
      qrScannerImageFailed: "Failed to scan the selected image.",
      qrScannerImageUnavailable: "QR image scanning is not available in this browser session.",
    ...
    detail: {
      ...
      details: "Details",
      detailsHelp: "Code, status, and current/home placement.",
      qrPreview: "QR code",
  ...
  nb: {
    ...
    storage: {
      ...
      openSpoolByQr: "Åpne spole",
      qrScanner: "Skann QR",
      qrScannerHelp:
        "Bruk enhetskameraet når nettleseren tillater det, eller velg et bilde fra enheten for å skanne en QR-kode.",
      qrScannerStart: "Start kamera",
      qrScannerStop: "Stopp kamera",
      qrScannerPhoto: "Skann fra bilde",
      qrScannerLiveUnavailable: "Direkte kameraskanning er ikke tilgjengelig i denne nettleseren/økten.",
    ...
    status: {
      ...
      qrScannerStarting: "Starter kamera...",
      qrScannerLiveReady: "Kameraet kjører. Pek det mot en QR-kode.",
      qrScannerLiveFailed: "Direkte QR-skanning feilet.",
      qrScannerLiveUnavailable: "Direkte kameraskanning er ikke tilgjengelig i denne nettleserøkten.",
      qrScannerVideoUnavailable: "Forhåndsvisning for QR-skanner er ikke tilgjengelig.",
      qrScannerFound: "QR funnet. Åpner spole...",
      qrScannerImageReading: "Skanner valgt bilde...",
      qrScannerImageFailed: "Kunne ikke skanne det valgte bildet.",
      qrScannerImageUnavailable: "QR-skanning fra bilde er ikke tilgjengelig i denne nettleserøkten.",
    ...
    detail: {
      ...
      details: "Detaljer",
      detailsHelp: "Kode, status og nåværende/hjemmeplassering.",
      qrPreview: "QR-kode",
      ...
      eventTareWeightUpdate: "Tom rull-vekt oppdatert",
