...
export const itITDictionary: DictionaryNode = {
  ...
  inventory: {
    ...
    discontinued: "Interrotto",
    editHomeLocation: "Posizione della casa",
    ...
    homeLocationLabel: "Posizione della casa",
    ...
    loanOutRoll: "Bobina in prestito",
  ...
  loans: {
    ...
    consumed: "Consumato",
    csvExported: "Prestito CSV esportato.",
    desktopOnly:
      "Il monitoraggio del prestito è disponibile nella build dell'app desktop.",
    direction: "Direzione",
    directionInbound: "Preso in prestito",
    directionOutbound: "Prestito",
    error: {
    ...
    exportCsv: "Prestiti all'esportazione CSV",
    handBackAction: "Restituire la mano",
    handBackDialogHint:
    ...
    handBackDialogTitle: "Restituire la bobina presa in prestito",
    ...
    history: "Storia del prestito",
    historyHint:
      "Le righe aperte possono essere restituite o restituite qui, mentre le righe completate rimangono ricercabili come riferimento.",
    in: "In",
    lent: "Prestato",
  ...
  printers: {
    ...
    liveConnectionIdle: "Vivi inattivo",
  ...
  statistics: {
    ...
    activeAms: "slots caricato attivo",
    activeSlotsDetailTitle: "slots caricato attivo",
    allTime: "Tutto il tempo",
    assignedSlots: "Slots con bobine assegnate",
    borrowedInInUse: "Assegnato in prestito",
    borrowedInLowStock: "Preso in prestito in stock bassi",
    borrowedInOnHand: "Preso in prestito a portata di mano",
    borrowedInPrintUsage30d:
      "Utilizzo di stampe registrate · prese in prestito da altri",
    borrowedInShort: "In",
    ...
    noActiveSlotFilterMatch:
      "Nessuno slots caricato corrisponde al filtro di proprietà corrente.",
    noActiveSlotsBreakdown: "Nessun slots caricato in questo momento.",
    ...
    ownedInUse: "Di proprietà assegnato",
    ownedLowStock: "Possesso di scorte basse",
    ownedOnHand: "Di proprietà",
    ownedPrintUsage30d: "Utilizzo della stampa registrato · di proprietà",
    ownershipSnapshot: "Istantanea della proprietà",
    ownershipSnapshotHint:
      "Ripartizione aggiuntiva della proprietà per le scorte disponibili e l'utilizzo della stampa registrato. Le carte del titolo sopra mostrano ancora i totali combinati.",
    ...
    sortJobsDesc: "La maggior parte dei lavori",
