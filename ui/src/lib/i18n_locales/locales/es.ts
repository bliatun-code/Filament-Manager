...
export const esDictionary: DictionaryNode = {
  ...
  settings: {
    ...
    librarySyncLinkedHost: "Este dispositivo ya está vinculado a la biblioteca del host seleccionado.",
    ...
    librarySyncClientAuthCleared: "Se ha eliminado de este dispositivo la vinculación del cliente.",
    ...
    librarySyncStandaloneHint: "Este dispositivo continúa utilizando únicamente su biblioteca local.",
    ...
    librarySyncConfirmArmedHint: "Un clic más confirmará este cambio de función.",
    librarySyncMigrationStepExport: "Exportar una copia completa desde el host actual",
    librarySyncMigrationStepExportHint:
      "Utiliza el botón de exportación de abajo antes de importar en el siguiente equipo.",
    librarySyncMigrationStepImport: "Importar la copia completa en este dispositivo",
    ...
    companionStatusHint: "La API de bucle local y la interfaz web están alojadas por el proceso de escritorio.",
    companionShellUrl: "URL de la interfaz",
    companionShellUrlHint: "Servida localmente por la aplicación de escritorio.",
    ...
    trustedLanEnableLabel: "Activar el acceso desde navegador en la interfaz seleccionada",
    trustedLanQuickToggleHint: "Se ejecuta solo en la interfaz privada seleccionada.",
    trustedLanQuickToggleDisabledHint: "Aún no hay disponible ninguna interfaz LAN privada.",
    ...
    trustedLanStatusHintDisabled: "La aplicación web permanece apagada hasta que la actives aquí.",
    ...
    trustedLanInterfaceHintEnabled: "Se vincula únicamente a una interfaz privada.",
    trustedLanShellUrl: "URL de la LAN",
    trustedLanUrlUnavailable: "No disponible hasta activar el modo de LAN de confianza",
    ...
    trustedLanPortHint: "Mantén el puerto estable para que los enlaces de vinculación sean previsibles.",
    trustedLanSave: "Guardar red",
    trustedLanConfigSaved: "Ajustes de Companion en la LAN de confianza guardados.",
    trustedLanNetworkSaved: "Ajustes de red de la aplicación web guardados.",
    trustedLanBindTitle: "Vinculado solo a la interfaz",
    trustedLanBindBody: "Se vincula a una interfaz privada explícita, nunca a 0.0.0.0.",
    ...
    trustedLanPairingNoteTitle: "Autenticación solo para navegadores personales",
    trustedLanPairingNoteBody: "Acceso exclusivo desde navegador, sin rutas para la ingesta de dispositivos.",
    ...
    trustedLanPairingLabelPlaceholder: "Safari del iPad, teléfono de la cocina, MacBook del taller...",
    ...
    trustedLanPairingEmpty: "Crea un enlace de vinculación para mostrarlo aquí.",
    ...
    trustedLanPairingCopied: "Enlace de vinculación de la LAN de confianza copiado.",
    ...
    trustedLanPairingQrHint: "Crea un enlace de vinculación para generar la vista previa del QR.",
    ...
    trustedLanPairingQrScanTitle: "Escanea desde el navegador que quieras vincular",
    ...
    trustedLanBrowsersEmpty: "Aún no se ha vinculado ningún navegador en la LAN de confianza.",
    trustedLanNoActiveBrowsers: "No hay navegadores autorizados en este momento.",
    ...
    trustedLanConfirmRevokeBrowserAria: "Confirmar la revocación del acceso de {name}",
    trustedLanCancelRevokeBrowserAria: "Cancelar la revocación del acceso de {name}",
    ...
    trustedLanRevokeAllAria: "Revocar el acceso de los {count} navegadores autorizados",
    ...
    trustedLanConfirmRevokeAllAria: "Confirmar la revocación de todos los navegadores autorizados",
    trustedLanCancelRevokeAllAria: "Cancelar la revocación de todos los navegadores autorizados",
    ...
    trustedLanBrowserPairedDetected: "Se ha conectado un navegador vinculado nuevo.",
    trustedLanBrowserRevoked: "Navegador de la LAN de confianza revocado.",
    trustedLanAllBrowsersRevoked: "Se han revocado todos los navegadores de la LAN de confianza.",
