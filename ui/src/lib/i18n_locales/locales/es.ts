...
export const esDictionary: DictionaryNode = {
  ...
  settings: {
    ...
    bambuLiveCredentialsNote:
      "Las credenciales se guardan localmente en este equipo.",
    ...
    langSetDe: "Idioma configurado en alemán.",
    langSetEn: "Idioma configurado en inglés.",
    langSetFr: "Idioma configurado en francés.",
    langSetNb: "Idioma configurado en noruego.",
