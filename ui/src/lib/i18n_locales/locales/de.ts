...
export const deDictionary: DictionaryNode = {
  ...
  settings: {
    ...
    trustedLanTitle: "Trusted-LAN-Clientzugriff",
    trustedLanHelp:
      "Clientzugriff auf einer privaten LAN-Schnittstelle aktivieren. Die Desktop-App behält die Kontrolle.",
    ...
    trustedLanAuthPairing: "Kopplung pro Client",
    trustedLanAuthHint: "Clientweise Kopplung mit Cookies, Erneuerung und CSRF-Prüfungen.",
    ...
    trustedLanEnableLabel: "Trusted-LAN-Clientzugriff auf der ausgewählten Schnittstelle aktivieren",
    ...
    trustedLanPairingTitle: "Client koppeln",
    trustedLanPairingBody: "Erstelle einen einmalig verwendbaren Link für einen Browser oder Desktop-Client.",
    trustedLanCreatePairing: "Kopplungslink erstellen",
    trustedLanCreateAnotherPairing: "Weiteren Link erstellen",
    trustedLanPairingLabelInput: "Clientname",
    trustedLanPairingLabelPlaceholder: "iPad Safari, Küchenhandy, Werkstatt-MacBook...",
    trustedLanPairingLabelHint:
      "Optional. So bleibt die Liste gekoppelter Clients später verständlich.",
    ...
    trustedLanPairingNoteTitle: "Client koppeln",
    trustedLanPairingNoteBody: "Wähle in der Desktop-App unter Bibliothek und Web-App die Rolle Client und füge den Link ein. Öffne für die Web-App den Link oder scanne den QR-Code im gewünschten Browser.",
    trustedLanBrowsersTitle: "Gekoppelte Clients",
    trustedLanBrowsersBody:
      "Widerrufe einen Client, um Erneuerungen zu stoppen und seine aktuellen Sitzungen zu schließen.",
    trustedLanRevokeAll: "Alle widerrufen",
    trustedLanRevokeAllWithCount: "Alle widerrufen ({count})",
    trustedLanRevokeAllAria: "Zugriff für alle {count} autorisierten Clients widerrufen",
    trustedLanConfirmRevokeAll:
      "Zugriff für alle autorisierten Clients ({count}) widerrufen? Ihre aktuellen Sitzungen werden geschlossen und jeder Client muss erneut gekoppelt werden.",
    trustedLanConfirmRevokeAllAction: "Alle Widerrufe bestätigen",
    trustedLanConfirmRevokeAllAria: "Widerruf des Zugriffs für alle autorisierten Clients bestätigen",
    trustedLanCancelRevokeAllAria: "Widerruf für alle autorisierten Clients abbrechen",
    trustedLanBrowsersEmpty: "Noch keine Trusted-LAN-Clients gekoppelt.",
    trustedLanNoActiveBrowsers: "Derzeit keine autorisierten Clients.",
    trustedLanUnnamedBrowser: "Gekoppelter Client",
    ...
    trustedLanRevokedHistoryBody:
      "Lasse diesen Bereich geschlossen, sofern du keinen älteren Clientzugriff prüfen musst.",
    ...
    trustedLanRevokeBrowserAria: "Clientzugriff für {name} widerrufen",
    trustedLanConfirmRevokeBrowser:
      "Zugriff für {name} widerrufen? Die aktuellen Sitzungen werden geschlossen und der Client muss erneut gekoppelt werden.",
    trustedLanConfirmRevokeAction: "Widerruf bestätigen",
    trustedLanConfirmRevokeBrowserAria: "Widerruf des Clientzugriffs für {name} bestätigen",
    trustedLanCancelRevokeAction: "Abbrechen",
    trustedLanCancelRevokeBrowserAria: "Widerruf des Clientzugriffs für {name} abbrechen",
    ...
    trustedLanBrowserRevoked: "Trusted-LAN-Client widerrufen.",
    trustedLanAllBrowsersRevoked: "Alle Trusted-LAN-Clients widerrufen.",
    trustedLanBrowserPairedDetected: "Neuer gekoppelter Client verbunden.",
    catalogTabHelp:
    ...
    error: {
      ...
      loadTrustedLanPairedBrowsers: "Gekoppelte Clients konnten nicht aktualisiert werden.",
      revokeTrustedLanBrowser: "Trusted-LAN-Client konnte nicht widerrufen werden.",
      revokeAllTrustedLanBrowsers: "Trusted-LAN-Clients konnten nicht widerrufen werden.",
