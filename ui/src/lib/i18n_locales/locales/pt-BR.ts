...
export const ptBRDictionary: DictionaryNode = {
  ...
  inventory: {
    ...
    addFilamentSubtitle:
      "Adicione diretamente ao estoque ou mantenha a lista de desejos → sob pedido → fluxo de trabalho do estoque.",
    ...
    addToWishlistHelp:
      "Use a seleção atual para manter a lista de desejos → sob pedido → fluxo de trabalho em estoque.",
    ...
    assigned: "Atribuído",
    assignedSlotLabel: "Atribuído slot",
    ...
    error: {
      ...
      updateHomeLocation: "Falha ao salvar o local de residência.",
    ...
    historyEvent: {
      ...
      assignedToAms: "Atribuído à impressora slot",
    ...
    homeLocationOptional: "Local de residência (opcional)",
    ...
    keepUnassignedOption: "Não slot (manter não atribuído)",
    ...
    qrCode: "Código QR",
    qrCompanionLinkLabel: "Ligação Companion",
  ...
  loans: {
    ...
    consumed: "Consumido",
    csvExported: "Empréstimo CSV exportado.",
    desktopOnly:
      "O rastreamento de empréstimos está disponível na versão do aplicativo desktop.",
    direction: "Direção",
    directionInbound: "Emprestado em",
    directionOutbound: "Emprestado",
    error: {
    ...
    exportCsv: "Empréstimos à exportação CSV",
    ...
    historyHint:
      "As linhas abertas podem ser devolvidas ou devolvidas aqui, enquanto as linhas concluídas permanecem pesquisáveis ​​para referência.",
    in: "Em",
    lent: "Quaresma",
  ...
  printers: {
    ...
    liveConnectionIdle: "Viva ocioso",
  ...
  settings: {
    ...
    bambuLiveCapturedGroupCaption: "Campos ao vivo capturados",
    bambuLiveCapturedTable: "Campos ao vivo capturados",
    ...
    bambuLiveHost: "Impressora host / IP",
    ...
    bambuLivePrinterSerial: "Série da impressora",
    bambuLiveRawPayload: "Últimos dados brutos ao vivo",
    bambuLiveRawPayloadCopied: "Carga bruta ao vivo copiada.",
    bambuLiveSecondaryExternalSlotLabel: "slot externo secundário",
    bambuLiveSection: "Status Bambu ativo",
    ...
    inventoryOverviewPerPage: "rótulos por página",
  ...
  statistics: {
    ...
    activeAms: "slots carregado ativo",
    activeSlotsDetailTitle: "slots carregado ativo",
    allTime: "Todo o tempo",
    assignedSlots: "Slots com bobinas atribuídas",
    borrowedInInUse: "Emprestado atribuído",
    borrowedInLowStock: "Estoque baixo emprestado",
    borrowedInOnHand: "Emprestado em mãos",
    borrowedInPrintUsage30d:
      "Uso de impressão registrada · emprestada de terceiros",
    borrowedInShort: "Em",
    ...
    error: {
      ...
      loadFilamentBreakdown: "Falha ao carregar a quebra do filamento.",
    ...
    inboundUsage: "Uso emprestado pelo proprietário",
    inboundUsageByFilament: "Uso emprestado por filamento",
    inboundUsageHint:
    ...
    loadingInboundUsage: "Carregando uso emprestado...",
    ...
    noActiveSlotFilterMatch:
      "Nenhum slots carregado corresponde ao filtro de propriedade atual.",
    noActiveSlotsBreakdown: "Nenhum slots carregado no momento.",
    ...
    noInboundBreakdown:
      "Nenhum uso do proprietário emprestado foi registrado ainda.",
    noInboundUsage: "Nenhum uso emprestado registrado ainda.",
    ...
    ownedInUse: "Propriedade atribuída",
    ownedLowStock: "Estoque baixo possuído",
    ownedOnHand: "Possuído em mãos",
    ownedPrintUsage30d: "Uso de impressão registrada · propriedade",
    ownershipSnapshot: "Instantâneo de propriedade",
    ownershipSnapshotHint:
      "Divisão de propriedade de aditivos para estoque disponível e uso de impressão registrado. Os cartões de título acima ainda mostram os totais combinados.",
    ...
    sortJobsDesc: "A maioria dos empregos",
