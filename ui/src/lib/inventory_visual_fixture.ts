...
export function buildInventoryDetailVisualFixture(
  ...
  const spools: InventorySpool[] = [
    ...
    },
    {
      ...
      ownerName: "Makerspace",
      ownerContact: "lager@makerspace.test",
      ownershipNote: "Returneres etter messeprint.",
      remainingGrams: 612,
      spoolTareWeightGrams: 201,
      location: "Prosjektkasse",
      homeLocation: "Returhylle",
